...
そしてこのブログを開設して1ヶ月後、現在使用している<a href="https://jamstackthemes.dev/theme/jekyll-theme-yat/" target="_blank" rel="noopener noreferrer">Yat Theme</a>に移行します。これによりブログのデザインがかなりリッチになりました。
...
ここからブログを1年続けてみての感想を書くのですが、もちろん良いことと悪い事の両方があります。良いことが後のほうが読み味がスッキリすると思うのでまずは悪いことから書きます。
...
なので、情報発信をする上では、源流に近い英語の情報も参照する必要があるわけです。僕のブログで"参考サイト"に英語のサイトが載っていることがあるのは、僕がイキっているわけではなく、こういった理由があるためです。
...
例えば表示速度を上げたり、Googleが欲しがっているメタ情報をサイト内に埋め込んだり…
...
最近では、[一言日記](https://r-40021.github.io/blog/categories.html#h-%E4%B8%80%E8%A8%80%E6%97%A5%E8%A8%98)という企画を始めました。今までに何度か日記を書こうとしようとしたことがありましたが、結局3日も続きませんでした。しかし、ブログに日記を書くとなると外からの目を意識するようになるので、今の時点で1ヶ月続いています。これはすごいことです。(当社比)
